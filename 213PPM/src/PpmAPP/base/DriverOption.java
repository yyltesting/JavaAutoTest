...
//		option.sleep(1);
//		System.out.print(option.Text("请输入手机号"));
//		option.inputText("xpath", "//android.widget.EditText[@text='请输入手机号']", "15729866869");
//		option.sleep(1);
//		option.inputText("xpath", "//android.widget.EditText[@text='请输入密码']", "yyl123456");
//		option.sleep(1);
//		option.click("xpath", "//android.widget.Button[@text='登录']");
//		option.sleep(2);
//		option.waitFor(30, "xpath", "//android.view.View[@text='拖动下方滑块完成拼图']");
